...
// +kubebuilder:rbac:groups=kafka.dexter.dixon.com,resources=kafkaconsumers,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=kafka.dexter.dixon.com,resources=kafkaconsumers/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=kafka.dexter.dixon.com,resources=kafkaconsumers/finalizers,verbs=update
...
func (r *KafkaConsumerReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&kafkav1beta1.KafkaConsumer{}).
		Named("kafkaconsumer").
		Complete(r)
}
