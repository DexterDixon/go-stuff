...
import (
	...
	"github.com/DexterDixon/go-stuff/msg-util-operator/internal/controller"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "7458eae6.dexter.dixon.com",
	...
	if err := (&controller.KafkaProducerReconciler{
	...
	if err := (&controller.KafkaConsumerReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
